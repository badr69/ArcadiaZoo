...
class UserModel(UserMixin):
    def __init__(self, user_id, username, email, password_hash=None, role_id=None, role_name=None, created_at=None):
        self.user_id = user_id  # noinspection PyShadowingBuiltins
...
#     @property
#     def id(self):
#         """Pour Flask-Login compatibility"""
#         return self.user_id
#
#     @property
#     def role(self):
