...
# reviews_bp.route('/element/<string:element_id>', methods=['GET'])(ReviewController.get_review_by_element_id)
# reviews_bp.route('/published', methods=['GET'])(ReviewController.get_published_reviews)
# reviews_bp.route('/publish/<string:review_id>', methods=['PATCH'])(ReviewController.publish_review)
# reviews_bp.route('/delete/<string:review_id>', methods=['DELETE'])(ReviewController.delete_review)
#
