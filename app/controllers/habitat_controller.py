...
class HabitatController:
    ...
    def create_habitat():
        ...
        if form.validate_on_submit():
            ...
            # TODO: Vérifier qu’un fichier image a bien été uploadé
            if not file or file.filename == "":
                flash("Veuillez ajouter une image.", "danger")
                return render_template("habitat/create_habitat.html", form=form)

            # TODO: Sauvegarder le fichier de l’image de façon sécurisée
            try:
                ...
                # TODO: Construire le chemin relatif à stocker en BDD
                url_image = f"uploads/habitat_img/{filename}"

                # TODO: Appeler le service pour créer l’habitat en base
                ...
                # TODO: Flasher un message succès ou erreur selon résultat
                ...
                # TODO: Logger l’erreur et prévenir l’utilisateur
        ...
        # TODO: En cas de GET ou erreur, afficher formulaire vide ou avec erreurs
        return render_template("habitat/create_habitat.html", form=form)

    @staticmethod
    def update_habitat(habitat_id):
        # TODO: Récupérer habitat existant
        habitat = HabitatService.get_habitat_by_id(habitat_id)
        # TODO: Si non trouvé, flash message et rediriger
        if habitat is None:
            flash("Habitat non trouvé.", "danger")
            return redirect(url_for('habitat.list_all_habitats'))

        # TODO: Pré-remplir formulaire avec données existantes
        form = HabitatUpdateForm(obj=habitat)

        # TODO: Traiter soumission formulaire update
        if form.validate_on_submit():
            # TODO: Sanitize champs
            name = sanitize_html(form.name.data)
            file = form.url_image.data
            description = sanitize_html(form.description.data)

            # TODO: Détecter injection SQL sur champs texte
            if detect_sql_injection(name) or detect_sql_injection(description):
                flash("Invalide Input.", "danger")
                return render_template("habitat/update_habitat.html", form=form)

            # TODO: Gérer le remplacement de l’image si nouveau fichier uploadé
            ...
            # TODO: Appeler le service pour mise à jour
            result = HabitatService.update_habitat(habitat_id, name, url_image, description)
            # TODO: Flash message succès ou erreur
            if result['status']:
